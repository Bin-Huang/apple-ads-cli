...
export function registerNegativeKeywordCommands(program: Command): void {
  program
    .command("negative-keywords <campaign-id> <adgroup-id>")
    .description("List negative keywords for an ad group")
  ...
  program
    .command("campaign-negative-keywords <campaign-id>")
    .description("List campaign-level negative keywords")
    .option("--limit <n>", "Number of results (default 20)", "20")
    .option("--offset <n>", "Offset for pagination (default 0)", "0")
